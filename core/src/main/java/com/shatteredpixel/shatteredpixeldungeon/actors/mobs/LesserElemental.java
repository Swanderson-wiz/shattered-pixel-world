...
public abstract class LesserElemental extends Mob {
	...
	public static class LesserFireElemental extends LesserElemental {
		
		{
			spriteClass = LesserElementalSprite.Fire.class;
	...
	public static class NewbornLesserFireElemental extends LesserFireElemental {
		
		{
			spriteClass = LesserElementalSprite.NewbornFire.class;
	...
	public static class AllyNewBornLesserElemental extends NewbornLesserFireElemental {
	...
	public static class LesserFrostElemental extends LesserElemental {
		
		{
			spriteClass = LesserElementalSprite.Frost.class;
	...
	public static class LesserShockElemental extends LesserElemental {
		
		{
			spriteClass = LesserElementalSprite.Shock.class;
	...
	public static class LesserChaosElemental extends LesserElemental {
		
		{
			spriteClass = LesserElementalSprite.Chaos.class;
	...
	public static Class<? extends LesserElemental> random(){
		float altChance = 1/50f * RatSkull.exoticChanceMultiplier();
		if (Random.Float() < altChance){
			return LesserChaosElemental.class;
		}
		
		float roll = Random.Float();
		if (roll < 0.4f){
			return LesserFireElemental.class;
		} else if (roll < 0.8f){
			return LesserFrostElemental.class;
		} else {
			return LesserShockElemental.class;
		}
	}
}
