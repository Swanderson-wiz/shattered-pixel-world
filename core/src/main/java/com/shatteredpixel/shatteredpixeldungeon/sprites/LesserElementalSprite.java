...
public abstract class LesserElementalSprite extends MobSprite {
	...
	public LesserElementalSprite() {
		super();
		
		int c = texOffset();
		
		texture( Assets.Sprites.LESSER_ELEMENTAL);
	...
	public void zap( int cell ) {
		...
		MagicMissile.boltFromChar( parent,
				...
				new Callback() {
					@Override
					public void call() {
						((LesserElemental)ch).onZapComplete();
					}
				} );
	...
	public static class Fire extends LesserElementalSprite {
	...
	public static class NewbornFire extends LesserElementalSprite {
	...
	public static class Frost extends LesserElementalSprite {
	...
	public static class Shock extends LesserElementalSprite {
	...
	public static class Chaos extends LesserElementalSprite {
